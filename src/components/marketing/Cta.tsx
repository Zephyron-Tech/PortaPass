...
const variants = {
  ...
  quiet:
    "border border-hairline-strong bg-transparent text-ink-2 hover:border-ink hover:bg-black/[0.03] active:bg-black/[0.03] focus-visible:ring-ink focus-visible:ring-offset-[#faf9f7]",
  inverse:
    "bg-band-ink text-ink hover:bg-white active:bg-[#e9e1d4] focus-visible:ring-band-ink focus-visible:ring-offset-[#191713]",
  quietInverse:
    "border border-band-hairline bg-transparent text-band-ink hover:border-band-ink hover:bg-white/5 active:bg-white/5 focus-visible:ring-band-ink focus-visible:ring-offset-[#191713]",
};
