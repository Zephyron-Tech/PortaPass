...
function AppleMark({ size = 20 }: { size?: number }) {
  // viewBox tightened to the glyph's actual bounding box (x: 20.5-35.5,
  // y: 16-35) — Apple's shipped asset has huge built-in padding for a much
  // larger container, which made the mark render tiny at icon sizes.
  return (
    <svg width={size} height={size * (21 / 18)} viewBox="19.5 15 18 21" fill="currentColor" aria-hidden>
